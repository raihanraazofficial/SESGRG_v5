...
class SESGSheetsService:
    def __init__(self):
        ...
        self.news_events_api_url = os.environ.get(
            'NEWS_EVENTS_API_URL',
            "https://script.google.com/macros/s/AKfycbycsLGN8FsijaWEPVLYdnWbbvgmlA8WlaGF7ZxmOUNEBKQfSe-t0VdeQpQCwxKu8Aks/exec?sheet=sheet9"
        )
    ...
    def _convert_sheets_to_news_events(self, sheets_data) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if isinstance(sheets_data, list):
                ...
                # Handle nested data structure from Google Sheets API - look for 'news_events' key first
                data_rows = sheets_data.get('news_events', sheets_data.get('data', []))
