          ...
          <div className="p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 text-sm">
                Enter your credentials to access the new admin dashboard
              </p>
            </div>
              ...
              >
                {isLoading ? (
                  ...
                  <div className="flex items-center justify-center space-x-2">
                    ...
                    <span>Sign In to New Admin Panel</span>
                  </div>
                )}
              </Button>
            </form>
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
              <div className="flex items-start space-x-2">
                ...
                <div className="text-xs text-gray-600">
                  <p className="font-medium mb-1">New Admin Panel</p>
                  <p>Professional dashboard with interactive content management and rich text editor.</p>
                </div>
              </div>
            </div>
          </div>
