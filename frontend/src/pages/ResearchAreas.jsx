...
const ResearchAreas = () => {
  ...
  const fetchRealTimeData = async (areaTitle) => {
    try {
      ...
      console.log('🚀 Fetching real-time data for area:', areaTitle);
      ...
      console.log('✅ Learn More Filtered results from localStorage:', {
      ...
      console.log('✅ Learn More Fresh real-time data prepared from localStorage:', {
                    ...
                    <div className="mt-auto">
                      <Button
                        ...
                        onClick={async (e) => {
                          ...
                          // Show optimized loading indicator
                          button.innerHTML = '<div class="flex items-center justify-center space-x-2"><div class="w-4 h-4 border-2 border-emerald-600 border-t-transparent rounded-full animate-spin"></div><span>Opening...</span></div>';
                          button.disabled = true;
                          
                          try {
                            // Pre-load data in background while showing loading
                            setTimeout(async () => {
                              await openDetailedPage(area);
                              button.innerHTML = originalText;
                              button.disabled = false;
                            }, 100); // Minimal delay to show loading state
                          } catch (error) {
                            console.error('Error opening detailed page:', error);
                            button.innerHTML = originalText;
                            button.disabled = false;
                          }
                        }}
