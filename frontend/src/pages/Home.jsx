...
import { ArrowRight, BookOpen, Lightbulb, Award, ChevronLeft, ChevronRight, CheckCircle, RefreshCw } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {researchAreas.map((area, index) => (
              <Card key={area.id} className={`group hover:shadow-xl transition-all duration-300 border-0 shadow-lg overflow-hidden ${
